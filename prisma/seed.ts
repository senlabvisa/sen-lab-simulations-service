...
const SEEDS: Seed[] = [
  ...
  {
    title: 'Statistiques — moyenne de classe',
    subject: 'Maths',
    targetGrade: '4eme',
    slug: 'statistiques-4eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
  ...
  {
    title: 'Systèmes 2 équations 2 inconnues',
    subject: 'Maths',
    targetGrade: '3eme',
    slug: 'systemes-equations-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
    title: 'Agrandissement et réduction — carte du Sénégal',
    subject: 'Maths',
    targetGrade: '3eme',
    slug: 'agrandissement-reduction-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
  ...
  {
    title: 'Optique — lentilles convergentes',
    subject: 'Physique-Chimie',
    targetGrade: '4eme',
  ...
  {
    title: 'Atomes et molécules — CO₂, H₂O, NaCl',
    subject: 'Physique-Chimie',
    targetGrade: '4eme',
    slug: 'atomes-molecules-4eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
    title: 'Intensité et tension — multimètre virtuel',
    subject: 'Physique-Chimie',
    targetGrade: '4eme',
    slug: 'intensite-tension-4eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
  ...
  {
    title: 'Poids et masse — Terre vs Lune',
    subject: 'Physique-Chimie',
    targetGrade: '3eme',
    slug: 'poids-masse-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
    title: 'pH des solutions',
    subject: 'Physique-Chimie',
    targetGrade: '3eme',
    slug: 'ph-solutions-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
    title: 'Énergie électrique — facture Senelec',
    subject: 'Physique-Chimie',
    targetGrade: '3eme',
    slug: 'energie-electrique-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
  ...
  {
    title: 'Reproduction animale — métamorphose de la mouche',
    subject: 'SVT',
    targetGrade: '4eme',
    slug: 'reproduction-animale-4eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
  ...
  {
    title: 'Système nerveux — réflexe rotulien',
    subject: 'SVT',
    targetGrade: '3eme',
    slug: 'systeme-nerveux-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
    title: 'Procréation humaine — cycle menstruel',
    subject: 'SVT',
    targetGrade: '3eme',
    slug: 'procreation-humaine-3eme',
    rubricTemplate: STANDARD_RUBRIC,
  },
  {
